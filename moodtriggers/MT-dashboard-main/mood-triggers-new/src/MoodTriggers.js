...
import { Users, Download, BarChart2 , Mail, FileText} from 'lucide-react';
...
const MoodTriggers = () => {
    ...
    const [sensingTypes] = useState([
        'Location',
        'Gyroscope',             // was 'AngV'
        'Accelerometer',         // was 'Acc'
        'Light',                 // was 'Light'
        'Battery',
        'User Survey Responses', // was 'EMA_response'
        'Phone',
        'SMS',
        'App Usage'
      ]);
    ...
    const handleExportSubmit = async (event) => {
        ...
        try {
            ...
            // 8001 for port assume
            const response = await fetch(`${API_BASE_URL}/export_data?${queryParams}`);
            if (!response.ok) {
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button
                            ...
                            className={`flex items-center px-4 py-2 rounded-md text-sm font-medium ${
                                activeTab === 'SendEmail' ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                      ...
                      >
                          <FileText size={20} className="mr-2" /> Reports
                      </button>
                            ...
                            <div className="mb-4">
                                ...
                                <div className="text-center pt-6">
                                    <button
                                        ...
                                        disabled={loadingExport || selectedExportTypes.length === 0}
                                    >
